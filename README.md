...
Another approach is to use powerful searching algorithm like the DE algorithm to search the Hyperparameter domain and to find the best available set. This is have been done in python here. The results were very promising with an accuracy of 89% on the test data set.
* Data feathering: 
